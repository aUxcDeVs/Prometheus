...
--
-- namegenerators/mixed_il_mangled.lua
--
-- This Script provides a function for generation of mixed names using both Il1 and mangled character sets
...
-- Combined character sets from both generators
